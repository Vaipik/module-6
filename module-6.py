...
def file_replacement(elem, folders_pathes, extensions, files_in_folder):
    ...
    if elem.suffix[1:].upper() in images:
        transering_files(elem, 'images')

    elif elem.suffix[1:].upper() in video:
        transering_files(elem, 'video')
    
    elif elem.suffix[1:].upper() in documents:
        transering_files(elem, 'documents')
        
    elif elem.suffix[1:].upper() in audio:
        transering_files(elem, 'audio')
        
    elif elem.suffix[1:].upper() in archives:
        transering_files(elem, 'archives')
